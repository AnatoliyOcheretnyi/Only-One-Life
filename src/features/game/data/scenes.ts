...
const arc1Scenes: Scene[] = [
  ...
  // Craft path (20 scenes)
  {
    id: 'a1-craft-001',
    arc: 1,
    phase: 'early',
    vector: 'craft',
    title: 'Перша заготівля',
    text: 'Майстер відправляє тебе по деревину на схилі. Треба встигнути до дощу.',
    choices: [
      {
        id: 'craft-001-fast',
        label: 'Поспішити',
        ...
        baseChance: 0.6,
        path: 'craft',
        successText: 'Ти встигаєш і привозиш матеріал.',
        failText: 'Ти пошкоджуєш матеріал.',
        success: { skill: 1, money: 2 },
        fail: { reputation: -1 },
      },
      {
        id: 'craft-001-careful',
        label: 'Зробити обережно',
        description: 'Повільно, але надійно.',
        effort: 'mental',
        baseChance: 0.75,
        path: 'craft',
        successText: 'Майстер задоволений якістю.',
  ...
  },
  {
    ...
    phase: 'early',
    vector: 'craft',
    title: 'Несправний інструмент',
    text: 'Старий інструмент ламається посеред роботи.',
    choices: [
      {
        id: 'craft-002-repair',
        label: 'Спробувати полагодити',
        description: 'Навчишся на практиці.',
        effort: 'mental',
        baseChance: 0.55,
        path: 'craft',
        successText: 'Інструмент працює краще.',
        failText: 'Ти робиш гірше.',
        success: { skill: 2 },
        fail: { money: -1 },
      },
      {
        id: 'craft-002-borrow',
        label: 'Попросити позичити',
        description: 'Менше ризику, але репутація під питанням.',
        effort: 'social',
        baseChance: 0.6,
        path: 'craft',
        successText: 'Тобі допомагають.',
  ...
  },
  {
    ...
    phase: 'early',
    vector: 'craft',
    title: 'Гончарний круг',
    text: 'У майстерні тобі дозволяють спробувати гончарний круг.',
    choices: [
      {
        id: 'craft-003-learn',
        label: 'Навчитись',
        description: 'Шанс на нову навичку.',
        effort: 'mental',
        baseChance: 0.5,
        path: 'craft',
        successText: 'Ти робиш рівний глечик.',
        failText: 'Глина розвалюється.',
        success: { skill: 2, reputation: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'craft-003-help',
        label: 'Допомагати майстру',
        description: 'Менше ризику.',
        effort: 'physical',
        baseChance: 0.8,
        path: 'craft',
        successText: 'Ти отримуєш дрібну платню.',
        failText: 'Ти втомлюєшся.',
        success: { money: 2 },
        fail: { fatigue: 1 },
      },
    ],
  },
  {
    ...
    phase: 'early',
    vector: 'craft',
    title: 'Шкіряні ремені',
    text: 'Потрібно зробити кілька ременів до вечора.',
    choices: [
      {
        id: 'craft-004-stitch',
        label: 'Працювати точно',
        description: 'Якість важлива.',
        effort: 'mental',
        baseChance: 0.7,
        path: 'craft',
        successText: 'Ремені рівні й міцні.',
        failText: 'Ти псуєш шкіру.',
      ...
      },
      {
        id: 'craft-004-rush',
        label: 'Зробити швидко',
        description: 'Можеш не встигнути.',
        effort: 'physical',
        baseChance: 0.55,
        path: 'craft',
        successText: 'Ти здаєш роботу вчасно.',
        failText: 'Робота бракована.',
        success: { money: 3 },
        fail: { reputation: -2 },
      },
    ],
  },
  {
    ...
    vector: 'craft',
    title: 'Пробний виріб',
    text: 'Майстер просить зробити зразок для багатого клієнта.',
    choices: [
      {
        id: 'craft-005-precise',
        label: 'Бути дуже уважним',
        description: 'Шанс на похвалу.',
        effort: 'mental',
        baseChance: 0.6,
        path: 'craft',
        successText: 'Клієнт задоволений.',
        failText: 'Зразок виходить слабким.',
        success: { reputation: 2, skill: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'craft-005-ask',
        label: 'Попросити пораду',
        description: 'Менше ризику.',
        effort: 'social',
        baseChance: 0.75,
        path: 'craft',
        successText: 'Майстер допомагає.',
        failText: 'Майстер зайнятий.',
        success: { skill: 1 },
        fail: { reputation: -1 },
      },
    ],
  },
  {
    ...
    vector: 'craft',
    title: 'Ремонт воріт',
    text: 'Сусіди просять допомогти з воротами.',
    choices: [
      {
        id: 'craft-006-help',
        label: 'Допомогти',
        description: 'Станеш корисним.',
        effort: 'physical',
        baseChance: 0.7,
        path: 'craft',
        successText: 'Ворота знову тримаються.',
        failText: 'Ти робиш гірше.',
        success: { reputation: 2, karma: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'craft-006-charge',
        label: 'Взяти плату',
        description: 'Заробиш, але ризикуєш репутацією.',
        effort: 'social',
        baseChance: 0.55,
        path: 'craft',
        successText: 'Тобі платять.',
        failText: 'Тобі дорікають жадібністю.',
        success: { money: 3 },
        fail: { reputation: -2 },
      },
    ],
  },
  {
    ...
    phase: 'early',
    vector: 'craft',
    title: 'Ринок матеріалів',
    text: 'Ти маєш купити матеріали для майстра.',
    choices: [
      {
        id: 'craft-007-bargain',
        label: 'Торгуватись',
        description: 'Можеш знизити ціну.',
        effort: 'social',
        baseChance: 0.5,
        path: 'craft',
        successText: 'Ти економиш гроші майстра.',
        failText: 'Тебе обманюють.',
        success: { reputation: 1, money: 1 },
        fail: { money: -1 },
      },
      {
        id: 'craft-007-fast',
        label: 'Купити швидко',
        description: 'Без ризику, але дорожче.',
        effort: 'neutral',
        baseChance: 1,
        path: 'craft',
        successText: 'Ти швидко повертаєшся.',
        failText: 'Ти швидко повертаєшся.',
        success: { money: -1 },
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'craft',
    title: 'Перевірка цеху',
    text: 'Старші майстри перевіряють роботу.',
    choices: [
      {
        id: 'craft-008-present',
        label: 'Показати роботу',
        description: 'Шанс на визнання.',
        effort: 'social',
        baseChance: 0.55,
        path: 'craft',
        successText: 'Тебе хвалять.',
      ...
      },
      {
        id: 'craft-008-hide',
        label: 'Сховатися',
        description: 'Уникнути ризику.',
        effort: 'neutral',
        baseChance: 1,
        path: 'craft',
        successText: 'Тебе не помічають.',
        failText: 'Тебе не помічають.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'craft',
    title: 'Ніч у майстерні',
    text: 'Майстер просить залишитись після заходу сонця.',
    choices: [
      {
        id: 'craft-009-stay',
        label: 'Залишитись',
        description: 'Більше роботи, більше досвіду.',
        effort: 'physical',
        baseChance: 0.6,
        path: 'craft',
        successText: 'Ти робиш важливий прорив.',
        failText: 'Ти перевтомився.',
        success: { skill: 2, money: 2 },
        fail: { fatigue: 2 },
      },
      {
        id: 'craft-009-leave',
  ...
  },
  {
    ...
    phase: 'mid',
    vector: 'craft',
    title: 'Пошкоджений виріб',
    text: 'Клієнт повертає виріб і вимагає виправлення.',
    choices: [
      {
        id: 'craft-010-fix',
        label: 'Виправити',
        ...
        baseChance: 0.65,
        path: 'craft',
        successText: 'Ти рятуєш замовлення.',
        failText: 'Виріб не піддається.',
        success: { reputation: 2, skill: 1 },
        fail: { reputation: -2 },
      },
      {
        id: 'craft-010-refund',
        label: 'Повернути гроші',
        description: 'Менше ризику, але втрати.',
        effort: 'neutral',
        baseChance: 1,
        path: 'craft',
        successText: 'Ти уникаєш конфлікту.',
        failText: 'Ти уникаєш конфлікту.',
        success: { money: -2 },
        fail: {},
      },
    ],
  },
  {
    ...
    text: 'Виріб потрібно доставити багатому замовнику.',
    choices: [
      {
        id: 'craft-011-escort',
        label: 'Доставити особисто',
        description: 'Можеш отримати бонус.',
        effort: 'physical',
        baseChance: 0.6,
        path: 'craft',
        successText: 'Замовник дякує.',
        failText: 'Ти запізнюєшся.',
        success: { money: 3, reputation: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'craft-011-send',
        label: 'Передати через посильного',
        description: 'Безпечніше.',
        effort: 'neutral',
        baseChance: 1,
        path: 'craft',
        successText: 'Ти уникаєш ризику.',
        failText: 'Ти уникаєш ризику.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'craft',
    title: 'Майстерний секрет',
    text: 'Майстер натякає на секретний прийом.',
    choices: [
      {
        id: 'craft-012-ask',
        label: 'Попросити навчити',
        description: 'Шанс швидко зрости.',
        effort: 'social',
        baseChance: 0.5,
        path: 'craft',
        successText: 'Ти опановуєш новий прийом.',
        failText: 'Майстер відмовляє.',
        success: { skill: 3 },
        fail: { reputation: -1 },
      },
      {
        ...
        baseChance: 1,
        path: 'craft',
        successText: 'Ти залишаєш шанс на потім.',
        failText: 'Ти залишаєш шанс на потім.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'craft',
    title: 'Велике замовлення',
    text: 'Цех отримує велике замовлення, потрібна координація.',
    choices: [
      {
        id: 'craft-013-lead',
        label: 'Взяти відповідальність',
        description: 'Шанс на ріст.',
        effort: 'social',
        baseChance: 0.5,
        path: 'craft',
        successText: 'Ти ведеш людей успішно.',
        failText: 'Ти не справляєшся.',
        success: { reputation: 3, skill: 1 },
        fail: { reputation: -2 },
      },
      {
        id: 'craft-013-support',
        label: 'Підтримувати інших',
        description: 'Менше ризику.',
        effort: 'physical',
        baseChance: 0.7,
        path: 'craft',
        successText: 'Робота йде швидше.',
        failText: 'Ти перевтомлюєшся.',
        success: { money: 3 },
        fail: { fatigue: 2 },
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'craft',
    title: 'Клеймо майстра',
    text: 'Ти отримуєш шанс поставити власне клеймо.',
    choices: [
      {
        id: 'craft-014-accept',
        label: 'Прийняти',
        description: 'Відповідальність зростає.',
        effort: 'social',
        baseChance: 0.55,
        path: 'craft',
        successText: 'Твоє ім’я помічають.',
        failText: 'Ти не виправдовуєш довіру.',
        success: { reputation: 3 },
        fail: { reputation: -2 },
      },
      {
        id: 'craft-014-decline',
        label: 'Відмовитись',
        description: 'Ти не готовий.',
        effort: 'neutral',
        baseChance: 1,
        path: 'craft',
        successText: 'Ти відступаєш.',
        failText: 'Ти відступаєш.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'craft',
    title: 'Конкурентний виріб',
    text: 'Інший цех копіює ваші роботи.',
    choices: [
      {
        id: 'craft-015-improve',
        label: 'Покращити дизайн',
        description: 'Складніше, але ефективно.',
        effort: 'mental',
        baseChance: 0.5,
        path: 'craft',
        successText: 'Ваші вироби знову унікальні.',
        failText: 'Покращення провалюється.',
      ...
      },
      {
        ...
        baseChance: 1,
        path: 'craft',
        successText: 'Ти сподіваєшся на удачу.',
        failText: 'Ти сподіваєшся на удачу.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    vector: 'craft',
    title: 'Пошук учня',
    text: 'Тобі пропонують взяти учня.',
    choices: [
      {
        id: 'craft-016-accept',
        label: 'Взяти учня',
        description: 'Підсилює статус.',
        effort: 'social',
        baseChance: 0.6,
        path: 'craft',
        successText: 'Учень працює старанно.',
        failText: 'Учень виявляється лінивим.',
        success: { reputation: 2, karma: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'craft-016-decline',
        label: 'Відмовитись',
        description: 'Не готовий до відповідальності.',
        effort: 'neutral',
        baseChance: 1,
        path: 'craft',
        successText: 'Ти зосереджуєшся на роботі.',
        failText: 'Ти зосереджуєшся на роботі.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'craft',
    title: 'Міська виставка',
    text: 'Місто проводить невелику виставку ремесел.',
    choices: [
      {
        id: 'craft-017-show',
        label: 'Показати виріб',
        description: 'Ризик, але шанс на славу.',
        effort: 'social',
        baseChance: 0.5,
        path: 'craft',
        successText: 'Твою роботу помічають.',
        failText: 'Виріб не викликає інтересу.',
      ...
      },
      {
        ...
        baseChance: 1,
        path: 'craft',
        successText: 'Ти продовжуєш роботу.',
        failText: 'Ти продовжуєш роботу.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'craft',
    title: 'Старий контракт',
    text: 'З’являється старий клієнт із боргом.',
    choices: [
      {
        id: 'craft-018-collect',
        label: 'Вимагати оплату',
        description: 'Справедливо, але ризик.',
        effort: 'social',
        baseChance: 0.5,
        path: 'craft',
        successText: 'Ти отримуєш оплату.',
        failText: 'Клієнт ображається.',
        success: { money: 3, reputation: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'craft-018-forgive',
        label: 'Пробачити борг',
        description: 'Моральний вибір.',
        effort: 'neutral',
        baseChance: 1,
        path: 'craft',
        successText: 'Ти зберігаєш добру славу.',
        failText: 'Ти зберігаєш добру славу.',
        success: { karma: 2, reputation: 1 },
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'craft',
    title: 'Замовлення на оздобу',
    text: 'Тебе просять зробити оздобу для храму.',
    choices: [
      {
        id: 'craft-019-accept',
        label: 'Погодитись',
        description: 'Підвищить статус.',
        effort: 'mental',
        baseChance: 0.55,
        path: 'craft',
        successText: 'Ти створюєш гарну роботу.',
        failText: 'Ти не встигаєш вчасно.',
        success: { reputation: 3, karma: 1, money: 2 },
        fail: { reputation: -1 },
      },
      {
        id: 'craft-019-decline',
        label: 'Відмовитись',
        description: 'Менше відповідальності.',
        effort: 'neutral',
        baseChance: 1,
        path: 'craft',
  ...
  },
  {
    ...
    vector: 'craft',
    title: 'Повага цеху',
    text: 'Майстри обговорюють твоє підвищення.',
    choices: [
      {
        id: 'craft-020-accept',
        label: 'Прийняти статус',
        description: 'Закріплює шлях ремесла.',
        effort: 'social',
        baseChance: 0.55,
        path: 'craft',
        successText: 'Тебе визнають серед своїх.',
        failText: 'Ти не отримуєш підтримки.',
        success: { reputation: 3, skill: 1 },
        fail: { reputation: -2 },
      },
      {
        ...
        baseChance: 1,
        path: 'craft',
        successText: 'Ти залишаєшся на попередньому рівні.',
        failText: 'Ти залишаєшся на попередньому рівні.',
        success: {},
        fail: {},
      },
    ],
  ...
  // Service path (20 scenes)
  {
    ...
    vector: 'service',
    title: 'Ранковий пост',
    text: 'Ти отримуєш ранковий пост біля брами.',
    choices: [
      {
        id: 'service-001-alert',
        label: 'Бути уважним',
        description: 'Показати дисципліну.',
        effort: 'mental',
        baseChance: 0.65,
        path: 'service',
        successText: 'Начальник хвалить твою уважність.',
        failText: 'Ти пропускаєш дрібну підозру.',
        success: { reputation: 2 },
        fail: { reputation: -1 },
      },
      {
        id: 'service-001-chat',
        label: 'Поговорити з людьми',
        description: 'Можеш здобути зв’язки.',
        effort: 'social',
        baseChance: 0.5,
        path: 'service',
        successText: 'Люди довіряють тобі.',
        failText: 'Тебе відволікають.',
        success: { reputation: 1, luck: 1 },
        fail: { reputation: -1 },
      },
    ],
  },
  {
    ...
    phase: 'early',
    vector: 'service',
    title: 'Караванний супровід',
    text: 'Тобі пропонують короткий супровід торговців.',
    choices: [
      {
        id: 'service-002-accept',
        label: 'Погодитись',
        description: 'Ризик дороги.',
        effort: 'physical',
        baseChance: 0.55,
        path: 'service',
        successText: 'Караван вдячний.',
        failText: 'Ти втомлюєшся на шляху.',
        success: { reputation: 2, money: 2 },
        fail: { fatigue: 2 },
      },
      {
        id: 'service-002-decline',
        label: 'Відмовитись',
        description: 'Не хочеш ризику.',
        effort: 'neutral',
        baseChance: 1,
        path: 'service',
        successText: 'Ти залишаєшся в місті.',
        failText: 'Ти залишаєшся в місті.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'early',
    vector: 'service',
    title: 'Тренування з сержантом',
    text: 'Сержант проводить тренування для новачків.',
    choices: [
      {
        id: 'service-003-train',
        label: 'Старанно тренуватись',
        description: 'Шанс підняти навичку.',
        effort: 'physical',
        baseChance: 0.6,
        path: 'service',
        successText: 'Ти показуєш силу.',
  ...
  },
  {
    ...
    phase: 'early',
    vector: 'service',
    title: 'Сварка на ринку',
    text: 'Двоє торговців з’ясовують стосунки. Варта має втрутитись.',
    choices: [
      {
        id: 'service-004-calm',
        label: 'Заспокоїти',
        description: 'Показати авторитет.',
        effort: 'social',
        baseChance: 0.6,
        path: 'service',
        successText: 'Натовп заспокоюється.',
        failText: 'Сварка переходить у бійку.',
        success: { reputation: 2 },
        fail: { reputation: -1, health: -1 },
      },
      {
        id: 'service-004-force',
        label: 'Застосувати силу',
        description: 'Швидко, але ризиковано.',
        effort: 'physical',
        baseChance: 0.45,
        path: 'service',
        successText: 'Ти відганяєш людей.',
        failText: 'Ти отримуєш удар.',
        success: { reputation: 1, skill: 1 },
        fail: { health: -2 },
      },
  ...
  },
  {
    ...
    phase: 'early',
    vector: 'service',
    title: 'Пильність у складі',
    text: 'Тебе ставлять охороняти склад.',
    choices: [
      {
        id: 'service-005-watch',
        label: 'Пильнувати',
        description: 'Стабільно.',
        effort: 'mental',
        baseChance: 0.7,
        path: 'service',
        successText: 'Порушень немає.',
        failText: 'Дрібна крадіжка.',
        success: { reputation: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'service-005-patrol',
        label: 'Обійти район',
        description: 'Більше ризику.',
        effort: 'physical',
        baseChance: 0.55,
        path: 'service',
        successText: 'Ти знаходиш порушника.',
        failText: 'Ти втомлюєшся.',
        success: { skill: 1, reputation: 1 },
        fail: { fatigue: 1 },
      },
  ...
  },
  {
    ...
    vector: 'service',
    title: 'Дисципліна',
    text: 'Командир перевіряє дисципліну новачків.',
    choices: [
      {
        id: 'service-006-stand',
        label: 'Виконати наказ',
        description: 'Показати дисципліну.',
        effort: 'physical',
        baseChance: 0.7,
        path: 'service',
        successText: 'Командир задоволений.',
        failText: 'Ти помиляєшся.',
        success: { reputation: 2 },
        fail: { reputation: -1 },
      },
      {
        id: 'service-006-question',
        label: 'Поставити питання',
        description: 'Може роздратувати.',
        effort: 'social',
        baseChance: 0.4,
        path: 'service',
        successText: 'Командир пояснює.',
  ...
  },
  {
    ...
    vector: 'service',
    title: 'Нічний рейд',
    text: 'Варта готує нічний рейд проти злодіїв.',
    choices: [
      {
        id: 'service-007-join',
        label: 'Приєднатись',
        description: 'Ризик і досвід.',
        effort: 'physical',
        baseChance: 0.5,
        path: 'service',
        successText: 'Рейд проходить успішно.',
        failText: 'Ти отримуєш травму.',
        success: { skill: 2, reputation: 2 },
        fail: { health: -2 },
      },
      {
        ...
        baseChance: 1,
        path: 'service',
        successText: 'Ти залишаєшся на посту.',
        failText: 'Ти залишаєшся на посту.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    vector: 'service',
    title: 'Охорона свята',
    text: 'Місто святкує. Потрібна охорона.',
    choices: [
      {
        id: 'service-008-guard',
        label: 'Охороняти',
        description: 'Показати відповідальність.',
        effort: 'mental',
        baseChance: 0.65,
        path: 'service',
        successText: 'Свято проходить спокійно.',
        failText: 'Стається дрібний інцидент.',
        success: { reputation: 2 },
        fail: { reputation: -1 },
      },
      {
        id: 'service-008-enjoy',
        label: 'Відпочити',
        description: 'Зберегти сили.',
        effort: 'rest',
        baseChance: 1,
  ...
  },
  {
    ...
    phase: 'mid',
    vector: 'service',
    title: 'Розмова зі старостою',
    text: 'Староста питає про ситуацію в районі.',
    choices: [
      {
        id: 'service-009-report',
        label: 'Звітувати чесно',
        description: 'Показати довіру.',
        effort: 'social',
        baseChance: 0.6,
        path: 'service',
        successText: 'Староста дякує.',
        failText: 'Тебе не слухають.',
        success: { reputation: 2 },
        fail: { reputation: -1 },
      },
      {
        id: 'service-009-exaggerate',
        label: 'Перебільшити',
        description: 'Спроба виглядати важливішим.',
        effort: 'social',
        baseChance: 0.35,
        path: 'service',
        successText: 'Староста вражений.',
        failText: 'Тебе викривають.',
        success: { reputation: 1, karma: -1 },
        fail: { reputation: -2 },
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'service',
    title: 'Супровід судді',
    text: 'Суддя потребує охорони на виїзді.',
    choices: [
      {
        id: 'service-010-escort',
        label: 'Супроводжувати',
        description: 'Висока відповідальність.',
        effort: 'physical',
        baseChance: 0.55,
        path: 'service',
        successText: 'Ви дістаєтесь безпечно.',
        failText: 'Шлях виявляється важким.',
        success: { reputation: 3, money: 2 },
        fail: { health: -1 },
      },
      {
        id: 'service-010-decline',
        label: 'Відмовитись',
        description: 'Уникнути ризику.',
        effort: 'neutral',
        baseChance: 1,
  ...
  },
  {
    ...
    phase: 'mid',
    vector: 'service',
    title: 'Підозрілий подорожній',
    text: 'На брамі з’являється підозріла людина.',
    choices: [
      {
        id: 'service-011-check',
        label: 'Перевірити',
        description: 'Показати пильність.',
        effort: 'mental',
        baseChance: 0.6,
        path: 'service',
        successText: 'Ти знаходиш заборонене.',
        failText: 'Нічого не знаходиш.',
        success: { reputation: 2 },
        fail: { reputation: -1 },
      },
      {
        id: 'service-011-ignore',
        label: 'Пропустити',
        description: 'Без ризику.',
        effort: 'neutral',
        baseChance: 1,
  ...
  },
  {
    ...
    phase: 'mid',
    vector: 'service',
    title: 'Розмова з ветераном',
    text: 'Ветеран дає поради служби.',
    choices: [
      {
        id: 'service-012-listen',
        label: 'Слухати',
        description: 'Можеш отримати мудрість.',
        effort: 'mental',
        baseChance: 0.7,
        path: 'service',
        successText: 'Ти розумієш важливий урок.',
        failText: 'Ти відволікаєшся.',
        success: { skill: 1, reputation: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'service-012-argue',
        label: 'Заперечити',
        description: 'Може зашкодити.',
        effort: 'social',
        baseChance: 0.35,
        path: 'service',
        successText: 'Ветеран поважає твою сміливість.',
        failText: 'Ветеран розчарований.',
        success: { reputation: 1 },
        fail: { reputation: -2 },
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'service',
    title: 'Перевірка під час бурі',
    text: 'Негода ускладнює охорону складів.',
    choices: [
      {
        id: 'service-013-hold',
        label: 'Тримати пост',
        description: 'Важко, але потрібно.',
        effort: 'physical',
        baseChance: 0.55,
        path: 'service',
        successText: 'Склади в безпеці.',
        failText: 'Частина майна втрачається.',
        success: { reputation: 2 },
        fail: { reputation: -1, fatigue: 2 },
      },
      {
        id: 'service-013-help',
        label: 'Допомагати людям',
        description: 'Шанс на повагу.',
        effort: 'social',
        baseChance: 0.5,
        path: 'service',
        successText: 'Люди дякують.',
  ...
  },
  {
    ...
    phase: 'late',
    vector: 'service',
    title: 'Наказ коменданта',
    text: 'Комендант просить виконати складне завдання.',
    choices: [
      {
        id: 'service-014-accept',
        label: 'Виконати',
        description: 'Шанс на підвищення.',
        effort: 'physical',
        baseChance: 0.5,
        path: 'service',
        successText: 'Ти довів надійність.',
        failText: 'Ти не впорався.',
        success: { reputation: 3, skill: 1 },
        fail: { reputation: -2 },
      },
      {
        id: 'service-014-decline',
        label: 'Відмовитись',
        description: 'Уникнути ризику.',
        effort: 'neutral',
        baseChance: 1,
        path: 'service',
        successText: 'Ти залишаєшся на своєму місці.',
        failText: 'Ти залишаєшся на своєму місці.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'service',
    title: 'Супровід посланця',
    text: 'Посланець вирушає у важливу справу.',
    choices: [
      {
        id: 'service-015-escort',
        label: 'Супроводжувати',
        description: 'Відповідально.',
        effort: 'physical',
        baseChance: 0.55,
        path: 'service',
        successText: 'Подорож успішна.',
        failText: 'Шлях небезпечний.',
        success: { reputation: 2, money: 2 },
        fail: { health: -1 },
      },
      {
  ...
  },
  {
    ...
    vector: 'service',
    title: 'Миротворення',
    text: 'Дві родини сперечаються. Варта може втрутитись.',
    choices: [
      {
        id: 'service-016-mediate',
        label: 'Посередництво',
        description: 'Потрібна дипломатія.',
        effort: 'social',
        baseChance: 0.55,
        path: 'service',
        successText: 'Суперечку вирішено.',
        failText: 'Суперечка загострюється.',
        success: { reputation: 2, karma: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'service-016-force',
        label: 'Залякати',
        description: 'Швидко, але грубо.',
        effort: 'physical',
        baseChance: 0.45,
        path: 'service',
        successText: 'Суперечка затихає.',
        failText: 'Тобі чинять опір.',
        success: { reputation: 1, skill: 1, karma: -1 },
        fail: { health: -2 },
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'service',
    title: 'Довіра капітана',
    text: 'Капітан варти оцінює твою службу.',
    choices: [
      {
        id: 'service-017-prove',
        label: 'Довести надійність',
        description: 'Один шанс.',
        effort: 'mental',
        baseChance: 0.5,
        path: 'service',
        successText: 'Капітан довіряє тобі.',
        failText: 'Ти не проходиш перевірку.',
        success: { reputation: 3 },
        fail: { reputation: -2 },
      },
  ...
  },
  {
    ...
    phase: 'late',
    vector: 'service',
    title: 'Посилена охорона',
    text: 'Під час загрози місто підсилює охорону.',
    choices: [
      {
        id: 'service-018-guard',
        label: 'Вийти на службу',
        description: 'Потрібна витримка.',
        effort: 'physical',
        baseChance: 0.55,
        path: 'service',
        successText: 'Ти витримуєш зміни.',
        failText: 'Ти виснажуєшся.',
        success: { reputation: 2 },
        fail: { fatigue: 2 },
      },
  ...
  },
  {
    ...
    phase: 'late',
    vector: 'service',
    title: 'Підготовка до присяги',
    text: 'Ти наближаєшся до формальної присяги.',
    choices: [
      {
        id: 'service-019-prepare',
        label: 'Готуватись',
        description: 'Підсилює статус.',
        effort: 'mental',
        baseChance: 0.6,
        path: 'service',
        successText: 'Ти виглядаєш гідно.',
      ...
      },
      {
        ...
        baseChance: 1,
        path: 'service',
        successText: 'Ти відкладаєш.',
        failText: 'Ти відкладаєш.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    vector: 'service',
    title: 'Знак служби',
    text: 'Ти отримуєш знак служби від старших.',
    choices: [
      {
        id: 'service-020-accept',
        label: 'Прийняти',
        description: 'Закріпити шлях.',
        effort: 'social',
        baseChance: 0.6,
        path: 'service',
        successText: 'Ти стаєш повноправним служакою.',
        failText: 'Тобі не довіряють.',
        success: { reputation: 3, skill: 1 },
        fail: { reputation: -2 },
      },
      {
        id: 'service-020-decline',
        label: 'Відмовитись',
        description: 'Не готовий.',
        effort: 'neutral',
        baseChance: 1,
        path: 'service',
        successText: 'Ти відкладаєш рішення.',
        failText: 'Ти відкладаєш рішення.',
        success: {},
        fail: {},
      },
    ],
  ...
  // Trade path (20 scenes)
  {
    ...
    vector: 'trade',
    title: 'Перші покупки',
    text: 'Ти намагаєшся купити дешевий товар для перепродажу.',
    choices: [
      {
        id: 'trade-001-bargain',
        label: 'Торгуватись',
        description: 'Можеш виграти.',
        effort: 'social',
        baseChance: 0.55,
        path: 'trade',
        successText: 'Ти купуєш дешево.',
        failText: 'Ти переплачуєш.',
        success: { money: 2 },
        fail: { money: -1 },
      },
      {
        id: 'trade-001-safe',
        label: 'Купити надійно',
        description: 'Без ризику.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Ти отримуєш товар.',
        failText: 'Ти отримуєш товар.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'early',
    vector: 'trade',
    title: 'Дрібний продаж',
    text: 'Ти продаєш дрібні речі на площі.',
    choices: [
      {
        id: 'trade-002-call',
        label: 'Гучно кликати покупців',
        description: 'Привертає увагу.',
        effort: 'social',
        baseChance: 0.6,
        path: 'trade',
        successText: 'Продажі йдуть краще.',
        failText: 'Тебе просять замовкнути.',
        success: { money: 2, reputation: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'trade-002-quiet',
        label: 'Торгувати тихо',
        description: 'Менше ризику.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Ти продаєш кілька речей.',
        failText: 'Ти продаєш кілька речей.',
        success: { money: 1 },
        fail: {},
      },
    ],
  },
  {
    ...
    vector: 'trade',
    title: 'Вивчення цін',
    text: 'Ти слухаєш розмови торговців про ціни.',
    choices: [
      {
        id: 'trade-003-listen',
        label: 'Слухати уважно',
        description: 'Знання цін важливе.',
        effort: 'mental',
        baseChance: 0.7,
        path: 'trade',
        successText: 'Ти розумієш ринок.',
        failText: 'Ти плутаєшся.',
        success: { luck: 1, reputation: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'trade-003-ask',
        label: 'Питати прямо',
        description: 'Можеш дратувати людей.',
        effort: 'social',
        baseChance: 0.45,
        path: 'trade',
        successText: 'Тобі допомагають.',
  ...
  },
  {
    ...
    phase: 'early',
    vector: 'trade',
    title: 'Пошук партнера',
    text: 'Ти намагаєшся знайти людину для спільного продажу.',
    choices: [
      {
        id: 'trade-004-join',
        label: 'Укласти угоду',
        ...
        baseChance: 0.5,
        path: 'trade',
        successText: 'Угода приносить вигоду.',
        failText: 'Партнер обманює.',
        success: { money: 3, reputation: 1 },
        fail: { money: -2, reputation: -1 },
      },
      {
        id: 'trade-004-solo',
        label: 'Працювати самостійно',
        description: 'Менше ризику.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Ти залишаєшся незалежним.',
        failText: 'Ти залишаєшся незалежним.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'early',
    vector: 'trade',
    title: 'Клієнт із боргом',
    text: 'Клієнт просить відтермінувати оплату.',
    choices: [
      {
        id: 'trade-005-allow',
        label: 'Дати час',
        description: 'Можеш здобути довіру.',
        effort: 'social',
        baseChance: 0.6,
        path: 'trade',
        successText: 'Клієнт повертається.',
        failText: 'Клієнт зникає.',
        success: { reputation: 2 },
        fail: { money: -2 },
      },
      {
        id: 'trade-005-demand',
        label: 'Вимагати оплату',
        description: 'Ризик втратити клієнта.',
        effort: 'social',
        baseChance: 0.45,
        path: 'trade',
        successText: 'Клієнт платить.',
        failText: 'Клієнт злиться.',
        success: { money: 2 },
        fail: { reputation: -1 },
      },
    ],
  },
  {
    ...
    vector: 'trade',
    title: 'Поганий товар',
    text: 'Постачальник привіз товар гіршої якості.',
    choices: [
      {
        id: 'trade-006-argue',
        label: 'Сваритися',
        description: 'Можеш повернути гроші.',
        effort: 'social',
        baseChance: 0.5,
        path: 'trade',
        successText: 'Тобі повертають частину.',
        failText: 'Тобі відмовляють.',
        success: { money: 2 },
        fail: { money: -1 },
      },
      {
        id: 'trade-006-accept',
        label: 'Прийняти',
        description: 'Менше конфліктів.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Ти приймаєш втрати.',
        failText: 'Ти приймаєш втрати.',
        success: { reputation: 1 },
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'trade',
    title: 'Складські втрати',
    text: 'Частина товару зникає зі складу.',
    choices: [
      {
        id: 'trade-007-investigate',
        label: 'Розслідувати',
        description: 'Може знайти винного.',
        effort: 'mental',
        baseChance: 0.45,
        path: 'trade',
        successText: 'Ти знаходиш винного.',
        failText: 'Нічого не виявляєш.',
        success: { reputation: 2 },
        fail: { money: -2 },
      },
      {
        id: 'trade-007-absorb',
        label: 'Змиритись',
        description: 'Не витрачати час.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Ти списуєш втрати.',
        failText: 'Ти списуєш втрати.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'trade',
    title: 'Ярмарок у місті',
    text: 'Приїхав ярмарок, попит росте.',
    choices: [
      {
        id: 'trade-008-raise',
        label: 'Підняти ціну',
        ...
        baseChance: 0.55,
        path: 'trade',
        successText: 'Ти заробляєш більше.',
        failText: 'Покупці йдуть.',
        success: { money: 3 },
        fail: { reputation: -1 },
      },
      {
        id: 'trade-008-fair',
        label: 'Тримати ціну',
        description: 'Зберегти довіру.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Тебе рекомендують.',
        failText: 'Тебе рекомендують.',
        success: { reputation: 2 },
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'trade',
    title: 'Навчання рахунку',
    text: 'Тобі пропонують навчання торгівельного рахунку.',
    choices: [
      {
        id: 'trade-009-learn',
        label: 'Навчатися',
        description: 'Корисно для бізнесу.',
        effort: 'mental',
        baseChance: 0.6,
        path: 'trade',
        successText: 'Ти краще рахуєш витрати.',
        failText: 'Ти плутаєшся.',
        success: { reputation: 1, luck: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'trade-009-skip',
        label: 'Відмовитись',
        description: 'Не хочеш витрачати час.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Ти залишаєшся при своєму.',
  ...
  },
  {
    ...
    phase: 'mid',
    vector: 'trade',
    title: 'Сильний конкурент',
    text: 'Поряд відкривається новий прилавок.',
    choices: [
      {
        id: 'trade-010-improve',
        label: 'Покращити сервіс',
        description: 'Зберегти клієнтів.',
        effort: 'social',
        baseChance: 0.55,
        path: 'trade',
        successText: 'Клієнти залишаються з тобою.',
        failText: 'Частина клієнтів йде.',
      ...
      },
      {
        ...
        baseChance: 1,
        path: 'trade',
        successText: 'Ти зберігаєш спокій.',
        failText: 'Ти зберігаєш спокій.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'trade',
    title: 'Підробка монет',
    text: 'Хтось розраховується сумнівними монетами.',
    choices: [
      {
        id: 'trade-011-check',
        label: 'Перевірити монети',
        description: 'Пильність важлива.',
        effort: 'mental',
        baseChance: 0.6,
        path: 'trade',
        successText: 'Ти уникаєш втрат.',
        failText: 'Ти приймаєш підробку.',
        success: { reputation: 1 },
        fail: { money: -2 },
      },
      {
        ...
        baseChance: 1,
        path: 'trade',
        successText: 'Ти продовжуєш торг.',
        failText: 'Ти продовжуєш торг.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    vector: 'trade',
    title: 'Велике замовлення',
    text: 'Клієнт хоче великий обсяг товару.',
    choices: [
      {
        id: 'trade-012-accept',
        label: 'Погодитись',
        description: 'Шанс на великий прибуток.',
        effort: 'social',
        baseChance: 0.5,
        path: 'trade',
        successText: 'Замовлення вдається.',
        failText: 'Ти не справляєшся.',
        success: { money: 4, reputation: 2 },
        fail: { reputation: -2 },
      },
      {
        id: 'trade-012-decline',
        label: 'Відмовитись',
        description: 'Уникнути ризику.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Ти залишаєшся на місці.',
        failText: 'Ти залишаєшся на місці.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'trade',
    title: 'Контракт із майстром',
    text: 'Майстер хоче постачання матеріалів.',
    choices: [
      {
        id: 'trade-013-contract',
        label: 'Укласти контракт',
        description: 'Стабільний прибуток.',
        effort: 'social',
        baseChance: 0.55,
        path: 'trade',
        successText: 'Контракт приносить гроші.',
        failText: 'Контракт зривається.',
        success: { money: 4, reputation: 2 },
        fail: { reputation: -2 },
      },
      {
  ...
  },
  {
    ...
    phase: 'late',
    vector: 'trade',
    title: 'Розширення прилавку',
    text: 'Ти можеш орендувати більший прилавок.',
    choices: [
      {
        id: 'trade-014-expand',
        label: 'Розширитись',
        description: 'Потрібні гроші.',
        effort: 'social',
        baseChance: 0.5,
        path: 'trade',
        successText: 'Прибуток зростає.',
        failText: 'Ти втрачаєш гроші.',
        success: { money: 5, reputation: 1 },
        fail: { money: -3 },
      },
      {
        ...
        baseChance: 1,
        path: 'trade',
        successText: 'Ти працюєш як раніше.',
        failText: 'Ти працюєш як раніше.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'trade',
    title: 'Суперечка з партнером',
    text: 'Партнер вимагає більшу частку.',
    choices: [
      {
        id: 'trade-015-negotiate',
        label: 'Домовитись',
        description: 'Зберегти партнерство.',
        effort: 'social',
        baseChance: 0.5,
        path: 'trade',
        successText: 'Ви знаходите компроміс.',
        failText: 'Партнер іде.',
        success: { reputation: 2 },
        fail: { reputation: -2 },
      },
      {
        id: 'trade-015-split',
        label: 'Розірвати угоду',
        description: 'Стаєш самостійним.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Ти працюєш сам.',
        failText: 'Ти працюєш сам.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    vector: 'trade',
    title: 'Новий маршрут',
    text: 'Ти можеш вийти на новий торговий маршрут.',
    choices: [
      {
        id: 'trade-016-try',
        label: 'Спробувати',
        description: 'Ризик, але шанс на великий прибуток.',
        effort: 'physical',
        baseChance: 0.5,
        path: 'trade',
        successText: 'Маршрут приносить прибуток.',
        failText: 'Маршрут виявляється важким.',
        success: { money: 5, reputation: 2 },
        fail: { money: -3 },
      },
      {
  ...
  },
  {
    ...
    vector: 'trade',
    title: 'Міські збори',
    text: 'Ти отримуєш запрошення на збори торговців.',
    choices: [
      {
        id: 'trade-017-attend',
        label: 'Відвідати',
      ...
      },
      {
        ...
        baseChance: 1,
        path: 'trade',
        successText: 'Ти працюєш далі.',
        failText: 'Ти працюєш далі.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'trade',
    title: 'Перевірка податків',
    text: 'До тебе приходять податківці.',
    choices: [
      {
        id: 'trade-018-pay',
        label: 'Заплатити чесно',
        description: 'Без ризику, але боляче.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Ти платиш податок.',
        failText: 'Ти платиш податок.',
        success: { money: -2, karma: 1 },
        fail: {},
      },
      {
        id: 'trade-018-hide',
        label: 'Приховати прибуток',
        description: 'Ризиковано.',
        effort: 'social',
        baseChance: 0.35,
        path: 'trade',
        successText: 'Ти зберігаєш гроші.',
        failText: 'Тебе штрафують.',
        success: { money: 3, karma: -2 },
        fail: { money: -3, reputation: -2 },
      },
    ],
  },
  {
    ...
    phase: 'late',
    vector: 'trade',
    title: 'Склад із зерном',
    text: 'Зерно дешевшає. Є шанс купити багато.',
    choices: [
      {
        id: 'trade-019-buy',
        label: 'Купити багато',
        description: 'Ризик, але шанс на прибуток.',
        effort: 'mental',
        baseChance: 0.5,
        path: 'trade',
        successText: 'Ти заробляєш на перепродажі.',
        failText: 'Ціна падає ще більше.',
        success: { money: 4 },
        fail: { money: -2 },
      },
      {
  ...
  },
  {
    ...
    phase: 'late',
    vector: 'trade',
    title: 'Торгівельне ім’я',
    text: 'Ти формуєш власну репутацію як торговця.',
    choices: [
      {
        id: 'trade-020-brand',
        label: 'Підтвердити статус',
        description: 'Закріпити шлях.',
        effort: 'social',
        baseChance: 0.55,
        path: 'trade',
        successText: 'Твоє ім’я згадують на ринку.',
        failText: 'Твою репутацію ставлять під сумнів.',
        success: { reputation: 3, money: 2 },
        fail: { reputation: -2 },
      },
      {
        id: 'trade-020-wait',
        label: 'Почекати',
        description: 'Не поспішати.',
        effort: 'neutral',
        baseChance: 1,
        path: 'trade',
        successText: 'Ти залишаєшся в тіні.',
        failText: 'Ти залишаєшся в тіні.',
        success: {},
        fail: {},
      },
    ],
  ...
  // Crime path (20 scenes)
  {
    id: 'a1-crime-001',
    arc: 1,
    phase: 'early',
    vector: 'crime',
    title: 'Кишенькова справа',
    text: 'Ти бачиш роззяву з гаманцем.',
    choices: [
      {
        id: 'crime-001-steal',
        label: 'Вкрасти',
        ...
        baseChance: 0.4,
        path: 'crime',
        successText: 'Ти зникаєш у натовпі.',
        failText: 'Тебе ловлять.',
        success: { money: 4, karma: -2 },
        fail: { health: -2, reputation: -2, karma: -1 },
      },
      {
        id: 'crime-001-pass',
        label: 'Пройти повз',
  ...
  },
  {
    ...
    phase: 'early',
    vector: 'crime',
    title: 'Тіньовий контакт',
    text: 'Тобі пропонують дрібну послугу.',
    choices: [
      {
        id: 'crime-002-accept',
        label: 'Погодитись',
        description: 'Шанс на гроші.',
        effort: 'social',
        baseChance: 0.5,
        path: 'crime',
        successText: 'Ти отримуєш оплату.',
        failText: 'Тобі не платять.',
        success: { money: 3, karma: -1 },
        fail: { reputation: -1 },
      },
      {
        id: 'crime-002-decline',
        label: 'Відмовитись',
        description: 'Менше ризику.',
        effort: 'neutral',
        baseChance: 1,
  ...
  },
  {
    ...
    phase: 'early',
    vector: 'crime',
    title: 'Нічна доставка',
    text: 'Тобі дають пакунок для доставки у темряві.',
    choices: [
      {
        id: 'crime-003-carry',
        label: 'Прийняти',
        ...
        path: 'crime',
        successText: 'Ти доставляєш пакунок.',
        failText: 'Тебе зупиняє варта.',
        success: { money: 4, karma: -1 },
        fail: { reputation: -2, health: -1, karma: -1 },
      },
      {
        id: 'crime-003-refuse',
  ...
  },
  {
    ...
    phase: 'early',
    vector: 'crime',
    title: 'Підробка печатки',
    text: 'Тебе просять підробити печатку на документі.',
    choices: [
      {
        id: 'crime-004-forge',
        label: 'Погодитись',
        description: 'Складно, але вигідно.',
        effort: 'mental',
        baseChance: 0.35,
        path: 'crime',
        successText: 'Печатка виглядає справжньою.',
        failText: 'Підробку викривають.',
        success: { money: 5, karma: -2 },
        fail: { reputation: -3, health: -1 },
      },
      {
        id: 'crime-004-decline',
        label: 'Відмовитись',
        description: 'Менше ризику.',
        effort: 'neutral',
        baseChance: 1,
        path: 'crime',
        successText: 'Ти відходиш.',
        failText: 'Ти відходиш.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'early',
    vector: 'crime',
    title: 'Підглянути склад',
    text: 'Тобі потрібно оглянути склад перед пограбуванням.',
    choices: [
      {
        id: 'crime-005-scout',
        label: 'Піти на розвідку',
        description: 'Потрібна пильність.',
        effort: 'mental',
        baseChance: 0.55,
        path: 'crime',
        successText: 'Ти знаходиш слабке місце.',
        failText: 'Тебе помічають.',
        success: { luck: 1, karma: -1 },
        fail: { reputation: -1 },
      },
  ...
  },
  {
    ...
    phase: 'early',
    vector: 'crime',
    title: 'Швидка наводка',
    text: 'Тобі кажуть, що в одному домі зараз нікого немає.',
    choices: [
      {
        id: 'crime-006-break',
        label: 'Зламати',
        description: 'Ризиковано, але прибутково.',
        effort: 'physical',
        baseChance: 0.4,
        path: 'crime',
        successText: 'Ти забираєш трохи грошей.',
        failText: 'Тебе ловлять сусіди.',
        success: { money: 5, karma: -2 },
        fail: { health: -2, reputation: -2 },
      },
      {
        ...
        baseChance: 1,
        path: 'crime',
        successText: 'Ти не ризикуєш.',
        failText: 'Ти не ризикуєш.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'crime',
    title: 'Підкуп вартового',
    text: 'Потрібно домовитись із вартовим.',
    choices: [
      {
        id: 'crime-007-bribe',
        label: 'Дати підкуп',
        description: 'Може спрацювати.',
        effort: 'social',
        baseChance: 0.5,
        path: 'crime',
        successText: 'Вартовий відвертається.',
        failText: 'Він обурюється.',
        success: { money: -2, karma: -1, reputation: -1 },
        fail: { reputation: -2 },
      },
      {
        id: 'crime-007-avoid',
        label: 'Уникнути',
        description: 'Шукати інший шлях.',
        effort: 'neutral',
        baseChance: 1,
        path: 'crime',
        successText: 'Ти шукаєш інше рішення.',
        failText: 'Ти шукаєш інше рішення.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    vector: 'crime',
    title: 'Підозра',
    text: 'Ти відчуваєш, що за тобою стежать.',
    choices: [
      {
        id: 'crime-008-hide',
        label: 'Залягти на дно',
        description: 'Менше ризику.',
        effort: 'mental',
        baseChance: 0.6,
        path: 'crime',
        successText: 'Ти уникаєш небезпеки.',
        failText: 'Тебе все одно знаходять.',
        success: { luck: 1 },
        fail: { reputation: -1 },
      },
      {
        id: 'crime-008-run',
        label: 'Втекти з міста',
        description: 'Ризиковано.',
        effort: 'physical',
        baseChance: 0.45,
        path: 'crime',
        successText: 'Ти уникаєш переслідування.',
        failText: 'Тебе зупиняють.',
        success: { luck: 1, money: -1 },
        fail: { health: -2, reputation: -2 },
      },
    ],
  },
  {
    ...
    vector: 'crime',
    title: 'Схованка',
    text: 'Ти знаходиш стару схованку.',
    choices: [
      {
        id: 'crime-009-open',
        label: 'Відкрити',
        description: 'Може бути пастка.',
        effort: 'mental',
        baseChance: 0.45,
        path: 'crime',
        successText: 'Ти знаходиш дрібні гроші.',
        failText: 'Схованка порожня.',
        success: { money: 3, karma: -1 },
        fail: { reputation: -1 },
      },
      {
        ...
        baseChance: 1,
        path: 'crime',
        successText: 'Ти залишаєш її.',
        failText: 'Ти залишаєш її.',
        success: {},
        fail: {},
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'crime',
    title: 'Пограбування складу',
    text: 'Група пропонує пограбувати склад.',
    choices: [
      {
        id: 'crime-010-join',
        label: 'Приєднатись',
        description: 'Великий ризик.',
        effort: 'physical',
        baseChance: 0.35,
        path: 'crime',
        successText: 'Ти отримуєш частку.',
        failText: 'Вас ловлять.',
        success: { money: 6, karma: -2 },
        fail: { reputation: -3, health: -2 },
      },
      {
        id: 'crime-010-skip',
        label: 'Відмовитись',
  ...
  },
  {
    ...
    vector: 'crime',
    title: 'Закон у місті',
    text: 'Варта посилює контроль у кварталі.',
    choices: [
      {
        id: 'crime-011-laylow',
        label: 'Залягти на дно',
        ...
        baseChance: 1,
        path: 'crime',
        successText: 'Ти перечікуєш.',
        failText: 'Ти перечікуєш.',
        success: {},
        fail: {},
      },
      {
        id: 'crime-011-risk',
        label: 'Ризикнути',
        description: 'Можливо пощастить.',
        effort: 'social',
        baseChance: 0.3,
        path: 'crime',
        successText: 'Ти проходиш непоміченим.',
        failText: 'Тебе затримують.',
        success: { money: 3, karma: -1 },
        fail: { health: -2, reputation: -2 },
      },
    ],
  },
  {
    ...
    phase: 'mid',
    vector: 'crime',
    title: 'Тіньова позика',
    text: 'Тобі пропонують позику під відсотки.',
    choices: [
      {
        id: 'crime-012-accept',
        label: 'Взяти позику',
        description: 'Шанс на швидкий старт.',
        effort: 'social',
        baseChance: 0.5,
        path: 'crime',
        successText: 'Ти отримуєш гроші.',
        failText: 'Умови виявляються жорсткими.',
        success: { money: 4, karma: -1 },
        fail: { reputation: -1 },
      },
      {
        id: 'crime-012-decline',
        label: 'Відмовитись',
        description: 'Без ризику.',
        effort: 'neutral',
        baseChance: 1,
  ...
  },
  {
    ...
    phase: 'late',
    vector: 'crime',
    title: 'Підпільна зустріч',
    text: 'Тебе запрошують на зустріч тіньових людей.',
    choices: [
      {
        id: 'crime-013-join',
        label: 'Прийти',
        description: 'Ризик, але можливості.',
        effort: 'social',
        baseChance: 0.45,
        path: 'crime',
        successText: 'Тебе приймають.',
        failText: 'Тобі не довіряють.',
        success: { reputation: -1, money: 4, karma: -2 },
        fail: { reputation: -2 },
      },
      {
        id: 'crime-013-avoid',
  ...
  },
  {
    ...
    phase: 'late',
    vector: 'crime',
    title: 'Небезпечне замовлення',
    text: 'Тобі пропонують складну справу.',
    choices: [
      {
        id: 'crime-014-accept',
        label: 'Погодитись',
        description: 'Високий ризик.',
        effort: 'physical',
        baseChance: 0.35,
        path: 'crime',
        successText: 'Справу виконано.',
        failText: 'Тебе ранять.',
        success: { money: 6, karma: -2 },
  ...
  },
  {
    ...
    phase: 'late',
    vector: 'crime',
    title: 'Спроба підстави',
    text: 'Тебе намагаються підставити.',
    choices: [
      {
        id: 'crime-015-defend',
        label: 'Захиститись',
        description: 'Потрібна хитрість.',
        effort: 'mental',
        baseChance: 0.5,
        path: 'crime',
        successText: 'Ти виходиш сухим.',
        failText: 'Ти потрапляєш у пастку.',
        success: { reputation: -1, luck: 1 },
        fail: { health: -2, reputation: -2 },
      },
      {
  ...
  },
  {
    ...
    vector: 'crime',
    title: 'Чорний ринок',
    text: 'Ти отримуєш доступ до чорного ринку.',
    choices: [
      {
        id: 'crime-016-sell',
        label: 'Продати товар',
  ...
  },
  {
    ...
    vector: 'crime',
    title: 'Судовий тиск',
    text: 'Твої справи привертають увагу влади.',
    choices: [
      {
        id: 'crime-017-bribe',
        label: 'Підкупити',
        description: 'Ризиковано, але може спрацювати.',
        effort: 'social',
        baseChance: 0.4,
        path: 'crime',
        successText: 'Тебе відпускають.',
        failText: 'Тобі висувають звинувачення.',
        success: { money: -3, karma: -1 },
        fail: { reputation: -3, health: -1 },
      },
      {
  ...
  },
  {
    ...
    phase: 'late',
    vector: 'crime',
    title: 'Тіньовий контроль',
    text: 'Ти отримуєш вплив у тіньових колах.',
    choices: [
      {
        id: 'crime-018-accept',
        label: 'Прийняти вплив',
        description: 'Закріплює шлях.',
        effort: 'social',
        baseChance: 0.55,
        path: 'crime',
        successText: 'Ти отримуєш повагу в тіні.',
        failText: 'Тебе не визнають.',
        success: { money: 4, karma: -2 },
        fail: { reputation: -2 },
      },
      {
  ...
  },
  {
    ...
    vector: 'crime',
    title: 'Великий ризик',
    text: 'Ти можеш провернути велику справу.',
    choices: [
      {
        id: 'crime-019-accept',
        label: 'Ризикнути',
        description: 'Високий ризик і вигода.',
        effort: 'physical',
        baseChance: 0.3,
        path: 'crime',
        successText: 'Ти отримуєш велику частку.',
        failText: 'Тебе ловлять.',
        success: { money: 8, karma: -3 },
        fail: { reputation: -4, health: -2 },
      },
      {
        id: 'crime-019-decline',
        label: 'Відмовитись',
        description: 'Безпечно.',
        effort: 'neutral',
        baseChance: 1,
  ...
  },
  {
    ...
    phase: 'late',
    vector: 'crime',
    title: 'Визнання серед тіні',
    text: 'Тебе визнають у тіньовому світі.',
    choices: [
      {
        id: 'crime-020-accept',
        label: 'Прийняти статус',
        ...
        baseChance: 0.5,
        path: 'crime',
        successText: 'Ти стаєш помітною фігурою.',
        failText: 'Тебе не визнають.',
        success: { money: 5, karma: -2 },
        fail: { reputation: -2 },
      },
  ...
  // Low health survival scenes
  {
    ...
    minTurn: 3,
    maxStats: { health: 3 },
    title: 'Знахарка на околиці',
    text: 'Кажуть, знахарка допомагає тим, хто на межі. Але вона не працює без винагороди.',
    choices: [
      {
        id: 'health-healer-pay',
        label: 'Заплатити',
        description: 'Шанс на лікування.',
        effort: 'social',
        baseChance: 0.6,
        successText: 'Знахарка допомагає тобі.',
        failText: 'Лікування не допомагає.',
        success: { health: 3, money: -2, karma: 1 },
        fail: { money: -1 },
      },
      {
        id: 'health-healer-bargain',
        label: 'Домовитись про відпрацювання',
        description: 'Ризиковано, але дешево.',
        effort: 'social',
        baseChance: 0.45,
        successText: 'Ти отримуєш допомогу і борг.',
        failText: 'Тебе проганяють.',
  ...
  },
  {
    ...
    maxStats: { health: 3 },
    title: 'Цирульник',
    text: 'Цирульник пропонує просте лікування — швидко і боляче.',
    choices: [
      {
        id: 'health-barber-accept',
        label: 'Погодитись',
        description: 'Шанс на відновлення.',
        effort: 'physical',
        baseChance: 0.55,
        successText: 'Ти відчуваєш полегшення.',
        failText: 'Лікування дає ускладнення.',
        success: { health: 2, money: -1 },
        fail: { health: -1 },
      },
      {
        id: 'health-barber-refuse',
        label: 'Відмовитись',
        description: 'Уникнути ризику.',
        effort: 'neutral',
        baseChance: 1,
  ...
  {
    id: 'a1-health-alchemist',
    arc: 1,
    phase: 'mid',
    vector: 'neutral',
    minTurn: 4,
    maxStats: { health: 4 },
    title: 'Алхімік на ринку',
    text: 'Алхімік продає настоянку. Вона може допомогти — або зашкодити.',
    choices: [
      {
        id: 'health-alchemist-buy',
        label: 'Купити настоянку',
        description: 'Ризикований шанс.',
        effort: 'mental',
        baseChance: 0.5,
        successText: 'Ти відчуваєш приплив сил.',
        failText: 'Тебе нудить і слабшає.',
        success: { health: 3, money: -2, luck: 1 },
        fail: { health: -2, money: -1 },
      },
      {
        id: 'health-alchemist-pass',
        label: 'Не ризикувати',
        description: 'Безпечно.',
        effort: 'neutral',
        baseChance: 1,
        successText: 'Ти не купуєш.',
        failText: 'Ти не купуєш.',
        success: {},
        fail: {},
      },
    ],
  ...
  {
    id: 'a1-health-mushrooms',
    arc: 1,
    phase: 'early',
    vector: 'neutral',
    minTurn: 2,
    maxStats: { health: 3 },
    title: 'Знайдені гриби',
    text: 'У лісі ти знаходиш гриби. Можливо, вони допоможуть вижити.',
    choices: [
      {
        id: 'health-mushrooms-eat',
        label: 'Зʼїсти',
        description: 'Ризиковано.',
        effort: 'physical',
        baseChance: 0.4,
        successText: 'Ти відновлюєш сили.',
        failText: 'Тобі стає гірше.',
        success: { health: 2, hungerDebt: -1 },
        fail: { health: -2 },
      },
      {
        id: 'health-mushrooms-skip',
        label: 'Не чіпати',
        description: 'Без ризику.',
        effort: 'neutral',
        baseChance: 1,
  ...
  },
  {
    ...
    minTurn: 8,
    maxStats: { health: 4 },
    title: 'Трав’яний збір',
    text: 'Ти чуєш, що певні трави допомагають від слабкості.',
    choices: [
      {
        id: 'health-herbs-search',
        label: 'Піти шукати трави',
        description: 'Потрібні сили.',
        effort: 'physical',
        baseChance: 0.5,
        successText: 'Ти знаходиш потрібні трави.',
        failText: 'Ти не знаходиш нічого.',
        success: { health: 2, karma: 1 },
        fail: { fatigue: 2 },
      },
      {
        id: 'health-herbs-rest',
        label: 'Залишитись',
        description: 'Зберегти сили.',
        effort: 'rest',
        baseChance: 1,
